...
class emp_people_create(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.base_url = urlbase.sit_emp() + "/emp/saveEmployeeInfo"
    ...
    def test_editparam_correct(self):
        ...
        payload = {"id":self.s1,"empName":"ZHANGHAO1","empCname":"测试账号α","cellphone":"123456","email":"123@qq.com","empNo":"00900","opType":"1"}
        r2 = self.s.post(self.base_url, data=payload)
        self.result = r2.json()
        self.assertEqual(self.result['result'], True)
        self.assertEqual(self.result['resultObject'], None)
